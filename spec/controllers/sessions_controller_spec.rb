...
RSpec.describe SessionsController, type: :controller do
  ...
  describe "Login by user who is not exist" do
    it "fails login" do
      get :new
      post :create, params: { session: {email: 'notexist', password: 'notexist' } }
  ...
  describe "Login by user who is not activated" do
    it "fails login" do
      get :new
      post :create, params: { session: {email: negative_user.email, password: negative_user.password } }
  ...
  describe "Login by user who is activated without Remember me and Logout" do
    it "successes and not save cookies, deletes session when logout" do
      get :new
      post :create, params: { session: {email: active_user.email, password: active_user.password, remember_me: 0 } }
  ...
  describe "Login by user who is activated with Remember me and Logout" do
    it "successes and save cookies, deletes session and cookies when logout" do
      get :new
      post :create, params: { session: {email: active_user.email, password: active_user.password, remember_me: 1  } }
